...
### 1. 下载安装
前往 [Releases](https://github.com/lansespirit/Clipal/releases) 页面下载对应系统的二进制文件（当前稳定版：[`v0.11.4`](https://github.com/lansespirit/Clipal/releases/tag/v0.11.4)），并放入环境变量 `PATH` 中。
```bash
chmod +x clipal*
./clipal* --version
```
